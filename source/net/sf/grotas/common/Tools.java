...
public class Tools {
    ...
    /**
     *  Source code version of <code>some</code> that can be pasted into a Java source. The result
     *  is embedded in two quotes, escape characters are rendered where possible. Invisible
     *  characters are rendered as unicode escape. The value <code>null</code> results in the the
    ...
    /**
     *  Source code version of character <code>some</code> that can be pasted into a Java source.
     ...
     *
     * @param  digits  the number of digits the result should have at least; if necessary, leading
     *      "0"s are prepended
     * @param  prefix  the text to be used as the fist few characters of the result; "0x" if null.
     */
    //@ requires digits > 0;
    //@ requires digits <= MAX_HEX_DIGIT_COUNT;
    public /*@ pure @*/ String hexString(long value, int digits, /*@ nullable @*/ String prefix) {
